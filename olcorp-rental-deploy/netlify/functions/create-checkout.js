...
// so no package.json / node_modules bundling is required.
...
exports.handler = async function (event) {
  ...
  params.append("success_url", `${siteUrl}/rentalprep?paid=1`);
  params.append("cancel_url", `${siteUrl}/rentalprep?paid=0`);
